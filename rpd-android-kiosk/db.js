...
async function initSchema() {
  ...
  // Two admin-uploadable sound effects for the wheel game: the "cut" sound
  // played the instant it lands, and the "hurray" cheer played on confirm.
  // One row per kind — uploading again replaces it.
  await pool.query(`
